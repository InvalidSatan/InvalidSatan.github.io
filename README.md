...
<body class="bg-gray-900">
    ...
    <script type="text/babel">
        // FIX: This function waits for external libraries to be loaded before running the app.
        // It uses setInterval to periodically check if the necessary global variables (React, ReactDOM, LucideReact)
        // are available. This prevents race condition errors where the app script runs before its dependencies.
        function runWhenLibsAreReady() {
            ...
            function initializeApp() {
                // Deconstruct lucide-react library loaded from CDN
                const { ChevronLeft, ChevronRight, GraduationCap, Zap, Users, Building, Bot, BrainCircuit, Mic, FileText, BotMessageSquare, Lightbulb } = LucideReact;
                ...
                function App() {
                  ...
                  return (
                    <div className="bg-gray-900 text-white font-sans w-full min-h-screen flex flex-col items-center justify-center p-4">
